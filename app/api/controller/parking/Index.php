...
class Index extends Base
{
    ...
    public function merchant()
    {
        $info=[
            ...
            'total_activities_fee'=>ParkingRecords::where(['parking_id'=>$this->parking_id])->sum('activities_fee'),
            'total_activities_time'=>ParkingRecords::where(['parking_id'=>$this->parking_id])->sum('activities_time'),
