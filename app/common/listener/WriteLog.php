...
class WriteLog
{
    ...
    private $noWriteLog=[
        ...
        [
            ...
            'action'=>['captcha','qrcodeLogin','changeTheme']
        ],
        [
            'controller'=>'app\\parking\\controller\\Ajax',
            'action'=>'*'
        ],
        [
            'controller'=>'app\\parking\\controller\\Index',
            'action'=>['captcha','qrcodeLogin','changeTheme']
        ]
    ];
    ...
    public function writeAdminLog()
    {
        ...
        if(!$auth->isLogin()){
            $auth = ParkingAuthService::newInstance();
            if(!$auth->isLogin()){
                return;
            }
        }
