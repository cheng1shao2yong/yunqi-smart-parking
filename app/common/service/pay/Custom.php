 ...
 * 微信支付宝商户支付
 */
class Custom extends PayService {

    private $config;

    protected function init()
    {
        $this->pay_type_handle='微信支付宝商户支付';
        $this->config = [
            'wechat' => [
                'default' => [
    ...
    public function wechatMiniappPay()
    {
        ...
        $union=PayUnion::wechatminiapp(PayUnion::PAY_TYPE_HANDLE('微信支付宝商户支付'),$user,$this->pay_price,$handling_fees,$this->order_type,$this->attach,$this->order_body);
